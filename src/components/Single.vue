					...
					<div class="left-blog left-single">
						<div class="blog-left">
							<div class="blog-left-left">
                                <p>发布者 <span v-if="blog.name!='null'" v-text="blog.name" style="color:red;"></span> &nbsp;&nbsp;<span v-if="blog.time!='null'" v-text="blog.time"></span></p>
                            ...
                            <div class="blog-left-right">
                                ...
                                <p v-if="blog.text!='null'" v-text="blog.text"></p><p v-else>暂无内容</p>
                            </div>
...
import {sendPersonalMessage} from '../../src/api/Login'
  ...
  data(){
    return{
	  blog: {
		  name: sessionStorage.getItem('blogName'),
  ...
  components: {
   ...
   methods:{
	   changeArchive(time){
		   ...
		   sessionStorage.setItem('archiveTime',time)
